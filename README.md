...
This is a PyTorch implementation of the [CLSP](http://arxiv.org/abs/2408.16965) paper (ECCV'24).
...
1. Train a class-conditional diffusion model with the [classifer-free diffusion guidance](https://arxiv.org/abs/2207.12598)

```
CUDA_VISIBLE_DEVICES=0,1,2,3 python train_conditional_diffusion.py --config configs/conditional_diffusion_cifar10.yaml
```

2. Generate 8 synthetic positive images for each sample in the dataset
...
|--------------|:------:|:----------:|:----------------:|
| Cifar10      | 1000   |  [:link:](https://drive.google.com/file/d/1idXhZVfUCNvu4-cV4mWRPw8l3-fVPiZa/view?usp=sharing)       | [:link:](https://drive.google.com/file/d/1RFwcpnFQKHt1uUiuWHVI_nJd0tRnSocY/view?usp=sharing)            |
| Cifar100     | 1000   |  [:link:](https://drive.google.com/file/d/1Xvou2pe0CNkdV5iMEYPj2M8AEQSTbadJ/view?usp=sharing)       |  [:link:](https://drive.google.com/file/d/1yz4UykW5xfUzmak2_BWyXYvaNDSvXLvG/view?usp=sharing)       |
