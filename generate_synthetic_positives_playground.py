...
# ckpt_path = "./output/uncondition_diffusion_stl10_2024-09-06_09-55-41/Checkpoints/ckpt_ema_999_.pt"
ckpt_path = "./output/uncondition_diffusion_stl10_2024-09-27_12-26-45/Checkpoints/ckpt_ema_299_.pt"
# ckpt_path = "/afs/crc.nd.edu/user/d/dzeng2/code/clsp/output/uncondition_diffusion_stl10_2024-09-23_12-14-32/Checkpoints/ckpt_299_.pt"
...
# data_indices = [202]
data_indices = np.random.randint(low=0, high=10000, size=5).tolist()
images_for_show = []
...
for data_idx in data_indices:
    ...
    with torch.no_grad():
        ...
        sampledImgs = sampler(noisyImage, x_anchor=anchor_images, weight=interpolation_weight, sample_method=sample_method, ddim_sampling_timesteps=ddim_sampling_timesteps, ddim_eta=ddim_eta)
...
torchvision.utils.save_image(images_for_show, "synthetic_positives.png", nrow=batch_size+1)
