...
class GaussianDiffusionSampler(nn.Module):
    ...
    def forward(self, x_T, x_anchor=None, weight=None, sample_method="ddpm", ddim_sampling_timesteps=100, ddim_eta=1.0):
    ...
    def ddim(self, x_T, sampling_timesteps=100, eta=1.0):
