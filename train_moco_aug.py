"""MoCo V2 with additional data augmentation."""
...
def train(config: Dict):
    ...
    summary_string = f"moco_aug_{config['dataset']}_{config['backbone']}_bs-{config['batch_size']}_temp-{str(config['temperature'])}_{current_time}"
