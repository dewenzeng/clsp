"""Unet for class conditional diffusion model.

Adapted from https://github.com/zoubohao/DenoisingDiffusionProbabilityModel-ddpm-/blob/main/DiffusionFreeGuidence/ModelCondition.py
"""
...
class UNet(nn.Module):
    def __init__(self, T, num_classes, ch, ch_mult, num_res_blocks, dropout):
        ...
        self.cond_embedding = ConditionalEmbedding(num_classes, ch, tdim)
