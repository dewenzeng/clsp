"""SimCLR-aug: Replacing the additional synthetic positive in CLSP with a positive generated with naive data augmentation."""
...
def train(config):
    ...
    summary_string = f"simclr_aug_{config['dataset']}_{config['backbone']}_bs-{config['batch_size']}_temp-{str(config['temperature'])}_{current_time}"
...
if __name__ == '__main__':
    ...
    parser.add_argument("--config", type=str, default="configs/simclr_aug_cifar10.yaml")
